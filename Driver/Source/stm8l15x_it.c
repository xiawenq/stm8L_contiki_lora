 ...
 * This function wound been invoked by ISR of tick timer
 */
 ...
 */
extern void rtimer_irq_handler(void);
...
{
#if (defined DP_PORT_IS_USART1 || defined DP_PORT_IS_USART3)
