...
************************************************************************************************
*/
/* Convert value to ASCII, e.g 0=>'0', 10=>'A' */
#define VAL_2_ASCII(Val)    ((Val) < 10 ? ((Val) + '0') : ((Val) -10 + 'A'))
...
************************************************************************************************
*/
INT8U FormatPrintf(INT8S *p_chBuf, const char *p_chStr, INT32S lData, PRINTF_FORMAT eFormat)
{
    ...
    if (PRINTF_FORMAT_NONE != eFormat)
    {
        ...
        *p_chCur = '\0';    /* Set terminator */
        ...
        {
            byTemp = uData % byMod;
            *--p_chCur = (INT8S)VAL_2_ASCII(byTemp);
        } while (0 != (uData /= byMod));
...
void dbg_Printf(const char *p_chStr, INT32S lData, PRINTF_FORMAT eFormat)
{
    ...
    byLen = FormatPrintf((INT8S *)s_abyDbgBuf, p_chStr, lData, eFormat);
